...
* 🟢 Added Ruby Initable snippets - Brooke Kuhlmann
* 🔼 Updated Ruby Infusible snippets to use new triggers - Brooke Kuhlmann
* 🔼 Updated Ruby breakpoint snippets to include info - Brooke Kuhlmann
...
* ✅ Fixed Hanami action snippet to use Hanami base class - Brooke Kuhlmann
* 🟢 Added Bash array assign alias - Brooke Kuhlmann
* 🟢 Added Hanami DB snippets - Brooke Kuhlmann
* 🟢 Added Hanami view snippets - Brooke Kuhlmann
...
* 🟢 Added HTML script snippets - Brooke Kuhlmann
* 🟢 Added README Developer Certificate of Origin documentation - Brooke Kuhlmann
* 🟢 Added Vale integration - Brooke Kuhlmann
...
* 🟢 Added HTML popover target action snippet - Brooke Kuhlmann
* 🟢 Added IRB code snippets for commands and helpers - Brooke Kuhlmann
* 🔼 Updated Bash snippets to use single prefix - Brooke Kuhlmann
* 🔼 Updated HTML popover content snippet to default to auto - Brooke Kuhlmann
* 🔼 Updated citation URLs - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.3.2 - Brooke Kuhlmann
* ⛔️ Removed Elm snippets - Brooke Kuhlmann
* ⛔️ Removed Ruby Dry Container snippets - Brooke Kuhlmann
* ⛔️ Removed SCSS snippets - Brooke Kuhlmann
