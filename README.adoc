...
* Hanami Class (action) - `hca`
* Hanami Class (part) - `hcvp`
* Hanami Class (relation) - `hcl`
* Hanami Class (repository) - `hcr`
* Hanami Class (struct) - `hcs`
* Hanami Class (view context) - `hcvc`
* Hanami Class (view scope) - `hcvs`
* Hanami Class (view) - `hcv`
* Hanami Dependency (repository) - `hdr`
* Hanami Factory (build) - `hfb`
* Hanami Factory (create) - `hfc`
* Hanami Factory (trait) - `hft`
...
* Ruby Module (functionable) - `modf`
* Ruby Module (included) - `modi`
* Ruby Module (module function) - `modm`
