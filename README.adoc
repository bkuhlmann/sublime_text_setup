...
* Ruby AutoInjector (dependencies) - `aid`
* Ruby AutoInjector (include) - `aii`
* Ruby AutoInjector (setup) - `ais`
...
* Ruby Dry Container - Extract - `dcx`
* Ruby Dry Container - Include - `dci`
* Ruby Dry Container - Merge - `dcm`
...
* Ruby Dry Validation - Each (multiple line) - `dvem`
...
== link:https://www.alchemists.io/projects/sublime_text_setup/versions[Versions]
